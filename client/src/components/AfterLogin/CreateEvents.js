...
const CreateEvents = () => {
    ...
    const handleSubmit = async(e) => {
        e.preventedDefault();
        try{
            await axios.post(`http://localhost:9000/create-event`, {
                title, 
                description, 
                scheduledAt, 
                venue
                    ...
                    <div className='col-6 offset-3'> 
                        <form onSubmit={handleSubmit} className="mt-3">
                            ...
                            <div className="form-group mb-3">
                                ...
                                <select name="venue"className="form-control" value={venue} onChange={handleChange}>
                            ...
                            <button disabled={!title || !description || !scheduledAt || venue} className='btn btn-purple text-white'>Submit</button>
                        </form>
                    </div>
                </div>
            </div>
